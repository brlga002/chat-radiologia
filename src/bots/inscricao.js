...
const messageAutomatica = async (io,socket) => {
    ...
    await envio(`Etapa 4: Pagar a Taxa de Inscrição Profissional`);
    ...
    await envio(`Etapa 7: Após analisados dos seus documentos, é encaminhado para ser aprovado em Reunião de Diretoria, que se dá 01 (uma) vez ao mês`);
